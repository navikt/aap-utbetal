    ...
    fun hentMigreringStatus(): UtbetalingMigreringStatus {
        ...
        return UtbetalingMigreringStatus(
            antallIkkeMigrerteSaker = connection.queryFirst(antallIkkeMigrerteSakerSql) {setRowMapper { mapAntall(it) }},
             antallMigrerteSaker = connection.queryFirst(antallMigrerteSakerSql) {setRowMapper { mapAntall(it) }},
        )
    }

}

data class UtbetalingMigreringStatus(
    val antallIkkeMigrerteSaker: Int,
    val antallMigrerteSaker: Int,
)